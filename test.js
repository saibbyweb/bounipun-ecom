              ...
              value: function(e) {
                if (e) {
                  ...
                  (t.style.display = "block"),
                    ...
                    ).innerHTML = r["default"].formatMoney(
                      e.unit_price,
                      window.theme.moneyFormat
                    )),
                    (t.querySelector(
            ...
            },
            {
              ...
              value: function(e) {
                ...
                if (this.options.drawer && "cart" !== window.theme.pageType) {
                  ...
                  0 === this.itemCount
                    ? (this.element.innerHTML = i.querySelector(
                        ".shopify-section"
                    ...
                    : (n.replaceChild(
                      ...
                      (this.element.querySelector(
                        ".PageHeader"
                      ).innerHTML = i.querySelector(".PageHeader").innerHTML));
                var o = JSON.parse(
                    i
                ...
                a.append("view", "ajax"),
                  ...
                  fetch(
                    ...
                    t.text().then(function(t) {
                      ...
                      (i.innerHTML = t),
                        (e.collectionInnerElement.innerHTML = i.querySelector(
                          ".shopify-section"
                        ).innerHTML),
                        document.dispatchEvent(
                          new CustomEvent("theme:loading:end")
        ...
        return (
          _createClass(e, [
              ...
              value: function() {
                ...
                if (
                  ...
                  t.on("click", ".dot", function(t, i) {
                    ...
                    t.on("click", ".Product__SlideshowNavArrow", function(
                      t,
                      i
                    ) {
                      e._slideWillChange(),
              ...
              value: function(e) {
                ...
                if (
                  ...
                  if (
                    ...
                    let limit = 0;
                    if(this.productSlideshow !== undefined)
                        limit = this.productSlideshow.flickityInstance.cells.length
                    for (
                      var n = 0;
                      n !== limit;
                      ++n
                    ) {
                      var s = this.productSlideshow.flickityInstance.cells[n]
                          .element,
            ...
            },
            {
              key: "_onMediaPaused",
              value: function() {
                (this.productSlideshow.getFlickityInstance().options.draggable = !h[
                  "default"
            ...
            },
            {
              ...
              value: function(e, t) {
                ...
                for (
                  ...
                  var n = this.productSlideshow.flickityInstance.cells[i]
                      .element,
                    ...
                    if (
                      ...
                      this.options.stackProductImages &&
                        ...
                        this.options.showThumbnails &&
                          ...
                          (s = 250),
                        (this.carouselNavScrollSpy = new c[
                          "default"
                ...
                "" !== t &&
                  fetch(
                    ...
                    t.text().then(function(t) {
                      var i = document.createElement("div");
                      (i.innerHTML = t),
                        (e.element.innerHTML = i.querySelector(
                          ".Section"
                        ).innerHTML),
