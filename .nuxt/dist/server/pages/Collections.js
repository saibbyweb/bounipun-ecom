exports.ids = [99,1,6,29,30,35,51,56,57,61];
exports.modules = {
...
var add = __webpack_require__(3).default
module.exports.__inject__ = function (context) {
  add("7aab9a6b", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FilterProducts_vue_vue_type_style_index_0_id_5c15c2dc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(216);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FilterProducts_vue_vue_type_style_index_0_id_5c15c2dc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FilterProducts_vue_vue_type_style_index_0_id_5c15c2dc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FilterProducts_vue_vue_type_style_index_0_id_5c15c2dc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_FilterProducts_vue_vue_type_style_index_0_id_5c15c2dc_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_URL_REPLACEMENT_9___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_9___);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "@font-face{font-family:\"SF-Pro\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") format(\"truetype\")}@font-face{font-family:\"SF-Pro SemiBold\";font-style:normal;font-weight:700;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") format(\"truetype\")}@font-face{font-family:\"SF-Pro Bold\";font-style:normal;font-weight:900;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ") format(\"truetype\")}@font-face{font-family:\"Poppins\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ") format(\"truetype\")}@font-face{font-family:\"Poppins SemiBold\";font-style:normal;font-weight:700;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ") format(\"truetype\")}@font-face{font-family:\"Poppins Bold\";font-style:normal;font-weight:900;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_5___ + ") format(\"truetype\")}@font-face{font-family:\"Garamond\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_6___ + ") format(\"truetype\")}@font-face{font-family:\"Garamond-Bold\";font-style:normal;font-weight:800;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_7___ + ") format(\"truetype\")}@font-face{font-family:\"Charmonman\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_8___ + ") format(\"truetype\")}@font-face{font-family:\"DancingScript-Regular\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_9___ + ") format(\"truetype\")}.w-bold b[data-v-5c15c2dc]{font-family:\"SF-Pro Bold\";font-size:14px;text-transform:uppercase}html[data-v-5c15c2dc]{scroll-behavior:smooth}body[data-v-5c15c2dc]{margin:0!important;padding:0}*[data-v-5c15c2dc]{font-family:\"Poppins\";outline:none;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-tap-highlight-color:transparent;box-sizing:border-box}.pad-10[data-v-5c15c2dc]{padding:6%}button[data-v-5c15c2dc]{cursor:pointer;border:none;padding:1% 3%}button .icon[data-v-5c15c2dc]{width:7%}button.sub-action[data-v-5c15c2dc]{background-color:green}button.action[data-v-5c15c2dc]{position:relative;background-color:#333;color:#fff;font-family:\"Poppins SemiBold\";font-size:16px;text-transform:uppercase;transition:all .2s ease-in-out}button.action[data-v-5c15c2dc]:hover{background-color:#0e0e0e}@media(max-width:768px){button.action[data-v-5c15c2dc]{padding:2% 5%;width:100%}}button.action.delete[data-v-5c15c2dc]{background-color:#9d2424;font-size:10px}button.action.delete[data-v-5c15c2dc]:hover{background-color:#e01010}button.small[data-v-5c15c2dc]{font-size:11px;padding:1% 3%}button.clear[data-v-5c15c2dc]{background:transparent;padding:2% 5%}h1[data-v-5c15c2dc],h2[data-v-5c15c2dc],h3[data-v-5c15c2dc],h4[data-v-5c15c2dc],h5[data-v-5c15c2dc],h6[data-v-5c15c2dc],p[data-v-5c15c2dc],span[data-v-5c15c2dc]{margin:0;padding:0;color:#333}.page[data-v-5c15c2dc]{min-height:80vh;padding:5%;margin-top:20vh}@media(max-width:768px){.page[data-v-5c15c2dc]{margin-top:13vh;padding:7%}}.page.-wh[data-v-5c15c2dc]{padding:0 0 5%}.page.side-pad[data-v-5c15c2dc]{padding:2%}@media(max-width:768px){.page.-broad[data-v-5c15c2dc]{padding:2%}}.page .page-header[data-v-5c15c2dc]{width:100%;height:8vh;margin-bottom:20px;background-color:#efefef}@media(max-width:768px){.page .page-header[data-v-5c15c2dc]{height:10vw}}.page .page-header .title[data-v-5c15c2dc]{color:#333;font-family:\"Poppins SemiBold\";text-transform:uppercase;font-size:1.3vw}@media(max-width:768px){.page .page-header .title[data-v-5c15c2dc]{font-size:5.4vw}}.page .side-pad[data-v-5c15c2dc]{padding:0 5%}@media(max-width:768px){.page .side-pad[data-v-5c15c2dc]{padding:0 10%}}.pointer[data-v-5c15c2dc]{cursor:pointer}.center[data-v-5c15c2dc],.center-col[data-v-5c15c2dc]{display:flex;justify-content:center;align-items:center}.center-col[data-v-5c15c2dc]{flex-direction:column}.center-space[data-v-5c15c2dc]{display:flex;justify-content:space-around;align-items:center}.contents[data-v-5c15c2dc]{position:relative}.white[data-v-5c15c2dc]{color:#fff}.scrollable-list[data-v-5c15c2dc]{display:flex;overflow-x:auto;padding:5px}@media screen and (min-width:768px){.scrollable-list[data-v-5c15c2dc]{justify-content:center}}.scrollable-list[data-v-5c15c2dc]::-webkit-scrollbar{display:none}.scrollable-list .list[data-v-5c15c2dc]{display:flex;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}.shadow[data-v-5c15c2dc]{box-shadow:1px 1px 15px rgba(0,0,0,.16)}.action-complete[data-v-5c15c2dc]{margin-top:10px;width:50px}[data-v-5c15c2dc]::-webkit-scrollbar{display:none}p.msg[data-v-5c15c2dc]{color:#fff;font-size:10px;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;padding:5px;border-radius:4px;margin:10px 0}p.msg.error[data-v-5c15c2dc]{background-color:#a93737}p.msg.success[data-v-5c15c2dc]{background-color:#319a67}.flex[data-v-5c15c2dc]{display:flex}.flex.around[data-v-5c15c2dc]{justify-content:space-around}.flex.between[data-v-5c15c2dc]{justify-content:space-between}.flex.evenly[data-v-5c15c2dc]{justify-content:space-evenly}.flex.col[data-v-5c15c2dc]{flex-direction:column}.flex.wrap[data-v-5c15c2dc]{flex-wrap:wrap}.flex.center[data-v-5c15c2dc]{justify-content:center}.flex.center[data-v-5c15c2dc],.flex.v-center[data-v-5c15c2dc]{align-items:center}.flex.j-center[data-v-5c15c2dc]{justify-content:center}.flex.start[data-v-5c15c2dc]{justify-content:flex-start;align-items:flex-start}.flex.start.center[data-v-5c15c2dc]{align-items:center}.flex.baseline[data-v-5c15c2dc]{align-items:baseline}.flex.end[data-v-5c15c2dc]{justify-content:flex-end}.flex.end.center[data-v-5c15c2dc]{align-items:center}a[data-v-5c15c2dc]{text-decoration:none}@media(max-width:768px){.onlyDesktop[data-v-5c15c2dc]{display:none}}.onlyMobile[data-v-5c15c2dc]{display:none}@media(max-width:768px){.onlyMobile[data-v-5c15c2dc]{display:inline;display:initial}}.offcanvas-filters[data-v-5c15c2dc]{position:fixed;top:0;left:0;background:hsla(0,0%,100%,.94902);width:40vw;height:100vh;margin-left:-60vw;transition:all .4s ease-in-out;z-index:3;overflow-y:scroll}@media(max-width:768px){.offcanvas-filters[data-v-5c15c2dc]{width:60vw}}.offcanvas-filters .header[data-v-5c15c2dc]{display:flex;align-items:center;justify-content:space-between;position:absolute;top:0;left:0;width:100%;height:20vh;padding:2% 4%}.offcanvas-filters.visible[data-v-5c15c2dc]{margin-left:0}.offcanvas-filters .label[data-v-5c15c2dc]{font-family:\"SF-Pro\";text-transform:capitalize;font-size:12px;cursor:pointer}.offcanvas-filters .all-options[data-v-5c15c2dc]{padding:15% 5% 0}.offcanvas-filters .all-options .colors .option[data-v-5c15c2dc]{margin:5px}.offcanvas-filters .all-options .colors .option .color-box[data-v-5c15c2dc]{height:50px;width:50px;margin-left:5px}.offcanvas-filters .all-options .colors .option .label[data-v-5c15c2dc]{margin-top:10px}@media(max-width:768px){.offcanvas-filters .all-options .colors .option[data-v-5c15c2dc]{width:25%}.offcanvas-filters .all-options .colors .option .color-box[data-v-5c15c2dc]{height:30px;width:30px;margin:10px}.offcanvas-filters .all-options .colors .option .label[data-v-5c15c2dc]{font-size:10px;text-transform:capitalize}}.offcanvas-filters .close[data-v-5c15c2dc]{width:3%;transition:all .4s ease-in-out;cursor:pointer}.offcanvas-filters .close[data-v-5c15c2dc]:hover{transform:rotate(70deg)}@media(max-width:768px){.offcanvas-filters .close[data-v-5c15c2dc]{width:6%}}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
/* harmony default export */ var FilterProductsvue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    clearAllFilters() {
      ...
      this.filterData.selectedPriceRange = ""; // this.clearSort();
    ...
    async fetchFilterData() {
      ...
      this.filterData.variants = this.filterData.variants.filter(variant => ['SQUARE', 'SHAWL', 'STOLE'].includes(variant.name.toUpperCase())); // this.filterData.variants.forEach(f => {
...
var add = __webpack_require__(3).default
module.exports.__inject__ = function (context) {
  add("1dcb3154", content, true, context)
};
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Collections_vue_vue_type_style_index_0_id_3946b5e7_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(403);
/* harmony import */ var _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Collections_vue_vue_type_style_index_0_id_3946b5e7_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0___default = /*#__PURE__*/__webpack_require__.n(_node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Collections_vue_vue_type_style_index_0_id_3946b5e7_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__);
/* harmony reexport (unknown) */ for(var __WEBPACK_IMPORT_KEY__ in _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Collections_vue_vue_type_style_index_0_id_3946b5e7_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__) if(["default"].indexOf(__WEBPACK_IMPORT_KEY__) < 0) (function(key) { __webpack_require__.d(__webpack_exports__, key, function() { return _node_modules_vue_style_loader_index_js_ref_7_oneOf_1_0_node_modules_css_loader_dist_cjs_js_ref_7_oneOf_1_1_node_modules_vue_loader_lib_loaders_stylePostLoader_js_node_modules_postcss_loader_src_index_js_ref_7_oneOf_1_2_node_modules_sass_loader_dist_cjs_js_ref_7_oneOf_1_3_node_modules_sass_resources_loader_lib_loader_js_ref_7_oneOf_1_4_node_modules_nuxt_components_dist_loader_js_ref_0_0_node_modules_vue_loader_lib_index_js_vue_loader_options_Collections_vue_vue_type_style_index_0_id_3946b5e7_lang_scss_scoped_true___WEBPACK_IMPORTED_MODULE_0__[key]; }) }(__WEBPACK_IMPORT_KEY__));
...
var ___CSS_LOADER_URL_REPLACEMENT_9___ = ___CSS_LOADER_GET_URL_IMPORT___(___CSS_LOADER_URL_IMPORT_9___);
// Module
___CSS_LOADER_EXPORT___.push([module.i, "@font-face{font-family:\"SF-Pro\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_0___ + ") format(\"truetype\")}@font-face{font-family:\"SF-Pro SemiBold\";font-style:normal;font-weight:700;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_1___ + ") format(\"truetype\")}@font-face{font-family:\"SF-Pro Bold\";font-style:normal;font-weight:900;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_2___ + ") format(\"truetype\")}@font-face{font-family:\"Poppins\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_3___ + ") format(\"truetype\")}@font-face{font-family:\"Poppins SemiBold\";font-style:normal;font-weight:700;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_4___ + ") format(\"truetype\")}@font-face{font-family:\"Poppins Bold\";font-style:normal;font-weight:900;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_5___ + ") format(\"truetype\")}@font-face{font-family:\"Garamond\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_6___ + ") format(\"truetype\")}@font-face{font-family:\"Garamond-Bold\";font-style:normal;font-weight:800;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_7___ + ") format(\"truetype\")}@font-face{font-family:\"Charmonman\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_8___ + ") format(\"truetype\")}@font-face{font-family:\"DancingScript-Regular\";font-style:normal;font-weight:400;font-display:swap;src:url(" + ___CSS_LOADER_URL_REPLACEMENT_9___ + ") format(\"truetype\")}.w-bold b[data-v-3946b5e7]{font-family:\"SF-Pro Bold\";font-size:14px;text-transform:uppercase}html[data-v-3946b5e7]{scroll-behavior:smooth}body[data-v-3946b5e7]{margin:0!important;padding:0}*[data-v-3946b5e7]{font-family:\"Poppins\";outline:none;-webkit-tap-highlight-color:rgba(0,0,0,0);-webkit-tap-highlight-color:transparent;box-sizing:border-box}.pad-10[data-v-3946b5e7]{padding:6%}button[data-v-3946b5e7]{cursor:pointer;border:none;padding:1% 3%}button .icon[data-v-3946b5e7]{width:7%}button.sub-action[data-v-3946b5e7]{background-color:green}button.action[data-v-3946b5e7]{position:relative;background-color:#333;color:#fff;font-family:\"Poppins SemiBold\";font-size:16px;text-transform:uppercase;transition:all .2s ease-in-out}button.action[data-v-3946b5e7]:hover{background-color:#0e0e0e}@media(max-width:768px){button.action[data-v-3946b5e7]{padding:2% 5%;width:100%}}button.action.delete[data-v-3946b5e7]{background-color:#9d2424;font-size:10px}button.action.delete[data-v-3946b5e7]:hover{background-color:#e01010}button.small[data-v-3946b5e7]{font-size:11px;padding:1% 3%}button.clear[data-v-3946b5e7]{background:transparent;padding:2% 5%}h1[data-v-3946b5e7],h2[data-v-3946b5e7],h3[data-v-3946b5e7],h4[data-v-3946b5e7],h5[data-v-3946b5e7],h6[data-v-3946b5e7],p[data-v-3946b5e7],span[data-v-3946b5e7]{margin:0;padding:0;color:#333}.page[data-v-3946b5e7]{min-height:80vh;padding:5%;margin-top:20vh}@media(max-width:768px){.page[data-v-3946b5e7]{margin-top:13vh;padding:7%}}.page.-wh[data-v-3946b5e7]{padding:0 0 5%}.page.side-pad[data-v-3946b5e7]{padding:2%}@media(max-width:768px){.page.-broad[data-v-3946b5e7]{padding:2%}}.page .page-header[data-v-3946b5e7]{width:100%;height:8vh;margin-bottom:20px;background-color:#efefef}@media(max-width:768px){.page .page-header[data-v-3946b5e7]{height:10vw}}.page .page-header .title[data-v-3946b5e7]{color:#333;font-family:\"Poppins SemiBold\";text-transform:uppercase;font-size:1.3vw}@media(max-width:768px){.page .page-header .title[data-v-3946b5e7]{font-size:5.4vw}}.page .side-pad[data-v-3946b5e7]{padding:0 5%}@media(max-width:768px){.page .side-pad[data-v-3946b5e7]{padding:0 10%}}.pointer[data-v-3946b5e7]{cursor:pointer}.center[data-v-3946b5e7],.center-col[data-v-3946b5e7]{display:flex;justify-content:center;align-items:center}.center-col[data-v-3946b5e7]{flex-direction:column}.center-space[data-v-3946b5e7]{display:flex;justify-content:space-around;align-items:center}.contents[data-v-3946b5e7]{position:relative}.white[data-v-3946b5e7]{color:#fff}.scrollable-list[data-v-3946b5e7]{display:flex;overflow-x:auto;padding:5px}@media screen and (min-width:768px){.scrollable-list[data-v-3946b5e7]{justify-content:center}}.scrollable-list[data-v-3946b5e7]::-webkit-scrollbar{display:none}.scrollable-list .list[data-v-3946b5e7]{display:flex;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content}.shadow[data-v-3946b5e7]{box-shadow:1px 1px 15px rgba(0,0,0,.16)}.action-complete[data-v-3946b5e7]{margin-top:10px;width:50px}[data-v-3946b5e7]::-webkit-scrollbar{display:none}p.msg[data-v-3946b5e7]{color:#fff;font-size:10px;width:-webkit-fit-content;width:-moz-fit-content;width:fit-content;padding:5px;border-radius:4px;margin:10px 0}p.msg.error[data-v-3946b5e7]{background-color:#a93737}p.msg.success[data-v-3946b5e7]{background-color:#319a67}.flex[data-v-3946b5e7]{display:flex}.flex.around[data-v-3946b5e7]{justify-content:space-around}.flex.between[data-v-3946b5e7]{justify-content:space-between}.flex.evenly[data-v-3946b5e7]{justify-content:space-evenly}.flex.col[data-v-3946b5e7]{flex-direction:column}.flex.wrap[data-v-3946b5e7]{flex-wrap:wrap}.flex.center[data-v-3946b5e7]{justify-content:center}.flex.center[data-v-3946b5e7],.flex.v-center[data-v-3946b5e7]{align-items:center}.flex.j-center[data-v-3946b5e7]{justify-content:center}.flex.start[data-v-3946b5e7]{justify-content:flex-start;align-items:flex-start}.flex.start.center[data-v-3946b5e7]{align-items:center}.flex.baseline[data-v-3946b5e7]{align-items:baseline}.flex.end[data-v-3946b5e7]{justify-content:flex-end}.flex.end.center[data-v-3946b5e7]{align-items:center}a[data-v-3946b5e7]{text-decoration:none}@media(max-width:768px){.onlyDesktop[data-v-3946b5e7]{display:none}}.onlyMobile[data-v-3946b5e7]{display:none}@media(max-width:768px){.onlyMobile[data-v-3946b5e7]{display:inline;display:initial}}.c-header[data-v-3946b5e7]{height:40vw;margin-top:5vh;background-size:cover;width:100%}.c-header.collectionLocked[data-v-3946b5e7]{margin-top:0}.c-header .heading[data-v-3946b5e7]{color:#333;text-transform:uppercase;font-family:\"Poppins Bold\";font-size:10vw}.main-text-block[data-v-3946b5e7]{padding:5% 5% 2%}.main-text-block .text-1[data-v-3946b5e7]{font-family:\"Garamond-Bold\";margin-bottom:10px;font-size:26px;text-transform:uppercase;text-align:center}.main-text-block .text-2[data-v-3946b5e7]{font-size:14px;text-align:justify;margin-bottom:5px;font-family:\"Poppins\"}.main-text-block .text-3[data-v-3946b5e7]{font-family:\"DancingScript-Regular\";font-size:19px}.collection-items[data-v-3946b5e7]{display:flex;flex-wrap:wrap;justify-content:center}.locked[data-v-3946b5e7]{padding:1% 10%;width:60%}.locked .heading[data-v-3946b5e7]{font-family:\"SF-Pro Bold\";text-transform:uppercase;text-align:center}@media(max-width:768px){.locked[data-v-3946b5e7]{width:100%}}.color-categories[data-v-3946b5e7]{margin-top:20px}.color-categories .category-heading[data-v-3946b5e7]{font-weight:900;font-family:\"SF-Pro\";font-size:18px;color:#464646;padding-left:10%;color:#333}.color-categories .category-description[data-v-3946b5e7]{padding-left:10%;font-size:13px;color:#7f7f7f}.login[data-v-3946b5e7]{padding:2% 8%}.login .text[data-v-3946b5e7]{font-family:\"SF-Pro\";padding-bottom:10px}", ""]);
// Exports
module.exports = ___CSS_LOADER_EXPORT___;
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/Collections.vue?vue&type=template&id=3946b5e7&scoped=true&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"flex col page -wh",style:(_vm.collectionLockedAndUserAuthorized ? { backgroundColor: '#111' } : {})},[_vm._ssrNode(((_vm.collectionImageProvided && !_vm.collectionLocked)?("<div"+(_vm._ssrClass("c-header center",{ isEscape: _vm.isEscape, collectionLocked: _vm.collectionLocked }))+(_vm._ssrStyle(null,{
      backgroundImage: ("url(" + (_vm.getCollectionImage(_vm.collectionImage)) + ")"),
    }, null))+" data-v-3946b5e7>"+((_vm.collection.image === '')?("<h2 class=\"heading\" data-v-3946b5e7>"+_vm._ssrEscape("\n      "+_vm._s(_vm.collection.name)+"\n    ")+"</h2>"):"<!---->")+"</div>"):"<!---->")+" "),(_vm.collectionLocked)?_vm._ssrNode("<div class=\"locked-image-slideshow center\" data-v-3946b5e7>","</div>",[_c('slideshow',{attrs:{"size":"cover","images":_vm.fetchSlideshow(_vm.collection.lockedImages),"mSlideHeight":"120vw","dSlideHeight":"90vh","dSlideWidth":100,"autoplay":true,"main":true}})],1):_vm._e(),_vm._ssrNode(" "+((
      _vm.collection.mainTextBlock !== undefined &&
      _vm.collection.mainTextBlock.visible
    )?("<div class=\"main-text-block center-col pad\" data-v-3946b5e7><h2 class=\"text-1\""+(_vm._ssrStyle(null,_vm.collectionLockedAndUserAuthorized ? { color: 'white' } : {}, null))+" data-v-3946b5e7>"+_vm._ssrEscape("\n      "+_vm._s(_vm.collection.mainTextBlock.text1)+"\n    ")+"</h2> <p class=\"text-2\""+(_vm._ssrStyle(null,_vm.collectionLockedAndUserAuthorized ? { color: 'white' } : {}, null))+" data-v-3946b5e7>"+_vm._ssrEscape("\n      "+_vm._s(_vm.collection.mainTextBlock.text2)+"\n    ")+"</p> "+((!_vm.collectionLocked)?("<p class=\"text-3\""+(_vm._ssrStyle(null,_vm.collectionLockedAndUserAuthorized ? { color: 'white' } : {}, null))+" data-v-3946b5e7>"+_vm._ssrEscape("\n      "+_vm._s(_vm.collection.mainTextBlock.text3)+"\n    ")+"</p>"):("<p class=\"text-2\""+(_vm._ssrStyle(null,_vm.collectionLockedAndUserAuthorized ? { color: 'white' } : {}, null))+" data-v-3946b5e7>"+_vm._ssrEscape("\n      "+_vm._s(_vm.collection.lockedText)+"\n    ")+"</p>"))+"</div>"):"<!---->")+" "),(!_vm.collectionLocked)?_c('FilterSortToggles',{attrs:{"collectionView":true},on:{"openFilters":function($event){_vm.filtersOpen = true;
      _vm.sortOpen = false;},"openSort":function($event){_vm.sortOpen = true;
      _vm.filtersOpen = false;},"viewChanged":function($event){_vm.gridView = $event}}}):_vm._e(),_vm._ssrNode(" "),_c('FilterProducts',{ref:"filters",attrs:{"filtersOpen":_vm.filtersOpen,"collectionView":true,"isEscape":_vm.isEscape},on:{"close":function($event){_vm.filtersOpen = false},"updated":_vm.filtersUpdated,"dataFetched":function($event){_vm.filterDataFetched = true}}}),_vm._ssrNode(" "),_c('SortProducts',{attrs:{"sortOpen":_vm.sortOpen},on:{"close":function($event){_vm.sortOpen = false},"updated":_vm.sortUpdated}}),_vm._ssrNode(" "),(
      (!_vm.collectionLocked &&
        _vm.isEscape &&
        !_vm.noFilterOrSortApplied &&
        _vm.collectionSoftLockAccess) ||
      (!_vm.collectionLocked && !_vm.isEscape && _vm.collectionSoftLockAccess)
    )?_vm._ssrNode("<div class=\"collection-items\" data-v-3946b5e7>","</div>",[_vm._l((_vm.products),function(product,index){return _c('product-card',{key:index,attrs:{"product":product.color,"searchView":true,"activeColor":product.actualIndex,"gridView":_vm.gridView}})}),_vm._ssrNode(" "+((
        _vm.products.length === 0 &&
        !_vm.$store.state.customer.loading &&
        _vm.initialLoadComplete
      )?("<h3 data-v-3946b5e7>"+_vm._ssrEscape("\n      No products matched for "+_vm._s(_vm.collection.name)+"\n    ")+"</h3>"):"<!---->"))],2):_vm._e(),_vm._ssrNode(" "),(
      !_vm.collectionLocked &&
      _vm.isEscape &&
      _vm.noFilterOrSortApplied &&
      _vm.collectionSoftLockAccess
    )?_vm._ssrNode("<div data-v-3946b5e7>","</div>",_vm._l((_vm.escapeProduct),function(value,name,index){return _vm._ssrNode("<div class=\"color-categories\" data-v-3946b5e7>","</div>",[(value.length !== 0)?_vm._ssrNode("<div data-v-3946b5e7>","</div>",[_vm._ssrNode("<h5 class=\"category-heading\" data-v-3946b5e7>"+_vm._ssrEscape(_vm._s(value.name))+"</h5> <p class=\"category-description\" data-v-3946b5e7>"+_vm._ssrEscape(_vm._s(value.description))+"</p> "),_vm._ssrNode("<div class=\"collection-items\" data-v-3946b5e7>","</div>",_vm._l((value.colors),function(color,cIndex){return _c('product-card',{key:cIndex,attrs:{"product":_vm.adjustProduct(_vm.products[0], color.actualIndex),"activeColor":color.actualIndex,"gridView":_vm.gridView}})}),1)],2):_vm._e()])}),0):_vm._e(),_vm._ssrNode(" "),_vm._ssrNode("<div class=\"flex center\" data-v-3946b5e7>","</div>",[(_vm.collectionLockedAndUserAuthorized)?_vm._ssrNode("<div class=\"locked\" data-v-3946b5e7>","</div>",[_c('UnlockContent')],1):_vm._e()]),_vm._ssrNode(" "+((
      (_vm.collectionLocked || _vm.collectionSoftLocked) &&
      !_vm.$store.state.customer.authorized
    )?("<div class=\"flex center col login\" data-v-3946b5e7><p class=\"text\" data-v-3946b5e7>Please login first to unlock this collection</p> <button class=\"action\" data-v-3946b5e7>\n      Access Bounipun Account\n    </button></div>"):"<!---->"))],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/Collections.vue?vue&type=template&id=3946b5e7&scoped=true&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/Collections.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var Collectionsvue_type_script_lang_js_ = ({
  head() {
    ...
    return {
      title: `${(_this$collection = this.collection) === null || _this$collection === void 0 ? void 0 : _this$collection.name} | Bounipun Kashmir`
    };
  },
  ...
  computed: {
    ...
    collectionImage() {
      return this.collectionLocked ? this.collection.lockedImage : this.collection.image;
    },
    ...
    noFiltersApplied() {
      ...
      return this.rawCriterion.colors.length === 0 && this.rawCriterion.filters.availabilityType.length === 0 && this.rawCriterion.filters["variants._id"].length === 0;
    },

    noFilterOrSortApplied() {
      return this.noFiltersApplied && this.rawCriterion.sortBy["priceRange.startsAt"] === undefined;
    }

  },

  async mounted() {// if (this.isEscape) this.fetchCollectionProducts(this.$route.query.slug);
  },
  ...
  methods: {
    ...
    filtersUpdated(filterData) {
      this.filterData = filterData; // TODO: MAKE SURE the collection id is always present (filterData.collections)
    ...
    getCheckedOnes(options) {
      ...
      keys.forEach(key => {
        if (allOptions[key].checked === true) checkedOptions.push(allOptions[key].value);
      });
    ...
    async fetchResults() {
      ...
      const bounipunCollection = this.filterData.collections.find(col => col.slug.toUpperCase() == this.$route.query.slug.toUpperCase()); // TODO: added as expirement SET COLLECTION
      ...
      } catch (err) {// console.log("Oops, `window` is not defined");
      }
      ...
      response.docs.forEach(product => {
        ...
        if (product.availabilityType === "ready-to-ship" && product.type !== "third-party" && product.rtsDirectVariant !== undefined) {
          const foundVariant = this.filterData.variants.find(variant => variant.value === product.rtsDirectVariant);
          if (foundVariant !== undefined) product.rtsDirectVariant = foundVariant.name;
        }
      });
    ...
    processColorSegregation(matchedProducts) {
      ...
      this.products = segregated; // this.totalMatches = segregated.length;
    ...
    findMatchedColors(product) {
      console.log(product, "matched"); // return [{ color: product, actualIndex: -1 }];
    ...
    async sortEscape(products) {
      ...
      for (let i = 0; i < product.colors.length; i++) product.colors[i]._id = product.colorData[i];
...
/* nuxt-component-imports */
installComponents(component, {Slideshow: __webpack_require__(174).default,FilterSortToggles: __webpack_require__(322).default,FilterProducts: __webpack_require__(323).default,SortProducts: __webpack_require__(324).default,ProductCard: __webpack_require__(189).default,UnlockContent: __webpack_require__(325).default})
