exports.ids = [130,3,9,34,41,47,55,58,59,60,74,90,91];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/homepage.vue?vue&type=template&id=aa580bb6&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"homepages crud"},[_vm._ssrNode("<div"+(_vm._ssrClass("filters center",{ updating: _vm.showForm }))+"><input type=\"text\" placeholder=\"Search for Homepages\""+(_vm._ssrAttr("value",(_vm.rawCriterion.search.term)))+" class=\"search shadow\"></div> "),_vm._ssrNode("<div"+(_vm._ssrClass("list",{ updating: _vm.showForm }))+">","</div>",[_c('List',{attrs:{"list":_vm.list,"model":_vm.model,"headings":_vm.headings,"custom_css":"10% 60% 20% 10%","sortByFields":_vm.sortByFields},on:{"documentFetched":_vm.documentFetched,"sortToggled":_vm.sortToggled}}),_vm._ssrNode(" "),_c('Pagination',{ref:"pagination",attrs:{"model":_vm.model,"rawCriterion":_vm.rawCriterion},on:{"resultsFetched":_vm.resultsFetched}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div"+(_vm._ssrClass("update",{ updating: _vm.showForm }))+">","</div>",[_c('UpdateHomepage',{directives:[{name:"show",rawName:"v-show",value:(_vm.showForm),expression:"showForm"}],ref:"updateComponent",attrs:{"model":_vm.model},on:{"updated":_vm.updateList,"close":function($event){_vm.showForm = false}}}),_vm._ssrNode(" "),(!_vm.showForm)?_c('AddNewItem',{attrs:{"label":"Homepage"},on:{"showForm":function($event){_vm.showForm = true}}}):_vm._e()],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin-panel/homepage.vue?vue&type=template&id=aa580bb6&

// EXTERNAL MODULE: external "uuid"
var external_uuid_ = __webpack_require__(108);

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/homepage.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var homepagevue_type_script_lang_js_ = ({
  ...
  methods: {
    ...
    documentFetched(doc) {
      ...
      doc.collectionBlocks.forEach(block => block.key = Object(external_uuid_["v4"])());
      doc.productListBlocks.forEach(block => block.key = Object(external_uuid_["v4"])());
    ...
    populateForm(doc) {
      ...
      if (productListBlocks.length > 0) {
        for (let i = 0; i < productListBlocks.length; i++) {
          ...
          if (productListBlocks[i].moodImage !== "" || productListBlocks[i].moodImage !== undefined) updateComponent.$refs.imageUploader_productListMood[i].assignImages([{
            _id: "",
            mainImage: false,
...
// CONCATENATED MODULE: ./pages/admin-panel/homepage.vue?vue&type=script&lang=js&
 /* harmony default export */ var admin_panel_homepagevue_type_script_lang_js_ = (homepagevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admin-panel/homepage.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_panel_homepagevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* nuxt-component-imports */
installComponents(component, {List: __webpack_require__(152).default,Pagination: __webpack_require__(153).default,UpdateHomepage: __webpack_require__(459).default,AddNewItem: __webpack_require__(157).default})
