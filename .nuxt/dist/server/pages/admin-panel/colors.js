exports.ids = [124,3,9,34,41,47,55,58,59,60,68,90];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/colors/UpdateColor.vue?vue&type=template&id=9dbc42ee&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"contents"},[_c('CancelUpdate',{on:{"close":_vm.closeForm}}),_vm._ssrNode(" <h2 class=\"heading\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? 'Update' : 'Add New')+" Color ")+"</h2> "),(_vm.editMode)?_c('InputBox',{attrs:{"label":"Color ID","disabled":"","internal":true},model:{value:(_vm.doc._id),callback:function ($$v) {_vm.$set(_vm.doc, "_id", $$v)},expression:"doc._id"}}):_vm._e(),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Bounipun Color Code","internal":true},model:{value:(_vm.doc.code),callback:function ($$v) {_vm.$set(_vm.doc, "code", $$v)},expression:"doc.code"}}),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Color Name"},model:{value:(_vm.doc.name),callback:function ($$v) {_vm.$set(_vm.doc, "name", $$v)},expression:"doc.name"}}),_vm._ssrNode(" "),_c('SelectBox',{attrs:{"options":_vm.baseColors,"label":"Base Color"},model:{value:(_vm.doc.baseColor),callback:function ($$v) {_vm.$set(_vm.doc, "baseColor", $$v)},expression:"doc.baseColor"}}),_vm._ssrNode(" "),_c('SelectBox',{attrs:{"options":_vm.colorCategories,"label":"Type of Category"},model:{value:(_vm.doc.category),callback:function ($$v) {_vm.$set(_vm.doc, "category", $$v)},expression:"doc.category"}}),_vm._ssrNode(" "),_c('TextBox',{attrs:{"label":"Description","internal":true},model:{value:(_vm.doc.description),callback:function ($$v) {_vm.$set(_vm.doc, "description", $$v)},expression:"doc.description"}}),_vm._ssrNode(" "),_c('UploadImage',{ref:"imageUploader",attrs:{"multipleUpload":false,"label":"Set Color Image"},on:{"updated":_vm.imageListUpdated}}),_vm._ssrNode(" "),_c('Toggle',{attrs:{"label":"Status"},model:{value:(_vm.doc.status),callback:function ($$v) {_vm.$set(_vm.doc, "status", $$v)},expression:"doc.status"}}),_vm._ssrNode(" <div class=\"center-space\">"+((_vm.loading)?("<img src=\"/loading.gif\" class=\"loading\">"):"<!---->")+" "+((_vm.updated)?("<img src=\"/complete.gif\" class=\"action-complete\">"):"<!---->")+" <button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? "Edit" : "Add")+" Color ")+"</button> "+((_vm.editMode)?("<button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action delete\"> Delete </button>"):"<!---->")+"</div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/admin/colors/UpdateColor.vue?vue&type=template&id=9dbc42ee&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/colors/UpdateColor.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var UpdateColorvue_type_script_lang_js_ = ({
  props: {
    model: String,
...
// CONCATENATED MODULE: ./components/admin/colors/UpdateColor.vue?vue&type=script&lang=js&
 /* harmony default export */ var colors_UpdateColorvue_type_script_lang_js_ = (UpdateColorvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/admin/colors/UpdateColor.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  colors_UpdateColorvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var UpdateColor = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/colors.vue?vue&type=template&id=55ba0a9e&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"colors crud"},[_vm._ssrNode("<div"+(_vm._ssrClass("filters center",{updating: _vm.showForm}))+">","</div>",[_c('SelectBox',{attrs:{"options":_vm.searchBy,"label":"Search By"},model:{value:(_vm.rawCriterion.search.key),callback:function ($$v) {_vm.$set(_vm.rawCriterion.search, "key", $$v)},expression:"rawCriterion.search.key"}}),_vm._ssrNode(" <input type=\"text\" placeholder=\"Search for Colors\""+(_vm._ssrAttr("value",(_vm.rawCriterion.search.term)))+" class=\"search shadow\"> "),_c('SelectBox',{attrs:{"options":_vm.colorCategories,"label":"Color Category"},model:{value:(_vm.rawCriterion.filters.category),callback:function ($$v) {_vm.$set(_vm.rawCriterion.filters, "category", $$v)},expression:"rawCriterion.filters.category"}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div"+(_vm._ssrClass("list",{updating: _vm.showForm}))+">","</div>",[_c('List',{attrs:{"list":_vm.list,"model":_vm.model,"headings":_vm.headings,"custom_css":"10% 20% 20% 20% 20% 10%","sortByFields":_vm.sortByFields},on:{"documentFetched":_vm.documentFetched,"sortToggled":_vm.sortToggled}}),_vm._ssrNode(" "),_c('Pagination',{ref:"pagination",attrs:{"model":_vm.model,"rawCriterion":_vm.rawCriterion},on:{"resultsFetched":_vm.resultsFetched}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div"+(_vm._ssrClass("update",{updating: _vm.showForm}))+">","</div>",[_c('UpdateColor',{directives:[{name:"show",rawName:"v-show",value:(_vm.showForm),expression:"showForm"}],ref:"updateComponent",attrs:{"model":_vm.model,"colorCategories":_vm.colorCategories},on:{"updated":_vm.updateList,"close":function($event){_vm.showForm = false}}}),_vm._ssrNode(" "),(!_vm.showForm)?_c('AddNewItem',{attrs:{"label":"Color"},on:{"showForm":function($event){_vm.showForm = true}}}):_vm._e()],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin-panel/colors.vue?vue&type=template&id=55ba0a9e&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/colors.vue?vue&type=script&lang=js&
//
//
//
//
...
/* harmony default export */ var colorsvue_type_script_lang_js_ = ({
  ...
  async mounted() {
    await this.fetchColorCategories(); // await this.fetchList();
  },
...
// CONCATENATED MODULE: ./pages/admin-panel/colors.vue?vue&type=script&lang=js&
 /* harmony default export */ var admin_panel_colorsvue_type_script_lang_js_ = (colorsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admin-panel/colors.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_panel_colorsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
