exports.ids = [121,3,9,34,41,47,58,59,60,67];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/collection/UpdateCollectionCategory.vue?vue&type=template&id=a40d41d8&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"contents"},[_c('CancelUpdate',{on:{"close":_vm.closeForm}}),_vm._ssrNode(" <h2 class=\"heading\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? 'Update' : 'Add New')+" Collection Category ")+"</h2> "),(_vm.editMode)?_c('InputBox',{attrs:{"label":"Color Category ID","disabled":"","internal":true},model:{value:(_vm.doc._id),callback:function ($$v) {_vm.$set(_vm.doc, "_id", $$v)},expression:"doc._id"}}):_vm._e(),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Collection Category Name"},model:{value:(_vm.doc.name),callback:function ($$v) {_vm.$set(_vm.doc, "name", $$v)},expression:"doc.name"}}),_vm._ssrNode(" "),_c('TextBox',{attrs:{"label":"Description"},model:{value:(_vm.doc.description),callback:function ($$v) {_vm.$set(_vm.doc, "description", $$v)},expression:"doc.description"}}),_vm._ssrNode(" "),_c('Toggle',{attrs:{"label":"Status"},model:{value:(_vm.doc.status),callback:function ($$v) {_vm.$set(_vm.doc, "status", $$v)},expression:"doc.status"}}),_vm._ssrNode(" <div class=\"center-space\">"+((_vm.loading)?("<img src=\"/loading.gif\" class=\"loading\">"):"<!---->")+" "+((_vm.updated)?("<img src=\"/complete.gif\" class=\"action-complete\">"):"<!---->")+" <button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? "Edit" : "Add")+" Collection Category ")+"</button> "+((_vm.editMode)?("<button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action delete\"> Delete </button>"):"<!---->")+"</div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/admin/collection/UpdateCollectionCategory.vue?vue&type=template&id=a40d41d8&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/collection/UpdateCollectionCategory.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var UpdateCollectionCategoryvue_type_script_lang_js_ = ({
  props: {
    model: String
  },
...
// CONCATENATED MODULE: ./components/admin/collection/UpdateCollectionCategory.vue?vue&type=script&lang=js&
 /* harmony default export */ var collection_UpdateCollectionCategoryvue_type_script_lang_js_ = (UpdateCollectionCategoryvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/admin/collection/UpdateCollectionCategory.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  collection_UpdateCollectionCategoryvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var UpdateCollectionCategory = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/collectionCategories.vue?vue&type=template&id=2920fd6c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"collection-categories crud"},[_vm._ssrNode("<div"+(_vm._ssrClass("filters center",{updating: _vm.showForm}))+"><input type=\"text\" placeholder=\"Search for Collecyion Categories\""+(_vm._ssrAttr("value",(_vm.rawCriterion.search.term)))+" class=\"search shadow\"></div> "),_vm._ssrNode("<div"+(_vm._ssrClass("list",{updating: _vm.showForm}))+">","</div>",[_c('List',{attrs:{"list":_vm.list,"model":_vm.model,"headings":_vm.headings,"custom_css":"10% 30% 25% 10% 25%","sortByFields":_vm.sortByFields,"isDraggable":true},on:{"documentFetched":_vm.documentFetched,"sortToggled":_vm.sortToggled,"clearFilters":_vm.clearFilters,"refetchList":function($event){return _vm.updateList()}}}),_vm._ssrNode(" "),_c('Pagination',{ref:"pagination",attrs:{"model":_vm.model,"rawCriterion":_vm.rawCriterion},on:{"resultsFetched":_vm.resultsFetched}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div"+(_vm._ssrClass("update",{updating: _vm.showForm}))+">","</div>",[_c('UpdateCollectionCategory',{directives:[{name:"show",rawName:"v-show",value:(_vm.showForm),expression:"showForm"}],ref:"updateComponent",attrs:{"model":_vm.model},on:{"updated":_vm.updateList,"close":function($event){_vm.showForm = false}}}),_vm._ssrNode(" "),(!_vm.showForm)?_c('AddNewItem',{attrs:{"label":"Collection Category"},on:{"showForm":function($event){_vm.showForm = true}}}):_vm._e()],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin-panel/collectionCategories.vue?vue&type=template&id=2920fd6c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/collectionCategories.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var collectionCategoriesvue_type_script_lang_js_ = ({
  layout: 'admin',
...
// CONCATENATED MODULE: ./pages/admin-panel/collectionCategories.vue?vue&type=script&lang=js&
 /* harmony default export */ var admin_panel_collectionCategoriesvue_type_script_lang_js_ = (collectionCategoriesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admin-panel/collectionCategories.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_panel_collectionCategoriesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
