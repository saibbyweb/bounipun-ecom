exports.ids = [120,3,9,34,41,47,58,59,60,64];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/colors/UpdateBaseColor.vue?vue&type=template&id=7fc5b97f&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"contents"},[_c('CancelUpdate',{on:{"close":_vm.closeForm}}),_vm._ssrNode(" <h2 class=\"heading\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? 'Update' : 'Add New')+" Base Color ")+"</h2> "),(_vm.editMode)?_c('InputBox',{attrs:{"label":"Base Color ID","disabled":"","internal":true},model:{value:(_vm.doc._id),callback:function ($$v) {_vm.$set(_vm.doc, "_id", $$v)},expression:"doc._id"}}):_vm._e(),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Base Color Name"},model:{value:(_vm.doc.name),callback:function ($$v) {_vm.$set(_vm.doc, "name", $$v)},expression:"doc.name"}}),_vm._ssrNode(" "),_c('client-only',[_c('div',{staticClass:"center",staticStyle:{"position":"relative"}},[_c('verte',{staticStyle:{"position":"absolute","right":"5%","top":"50%"},attrs:{"model":"hex","menuPosition":"right","value":_vm.doc.hex},on:{"input":_vm.colorPicked}}),_vm._v(" "),_c('InputBox',{attrs:{"label":"HEX Color"},model:{value:(_vm.doc.hex),callback:function ($$v) {_vm.$set(_vm.doc, "hex", $$v)},expression:"doc.hex"}})],1)]),_vm._ssrNode(" "),_c('TextBox',{attrs:{"label":"Description","internal":true},model:{value:(_vm.doc.description),callback:function ($$v) {_vm.$set(_vm.doc, "description", $$v)},expression:"doc.description"}}),_vm._ssrNode(" "),_c('Toggle',{attrs:{"label":"Status"},model:{value:(_vm.doc.status),callback:function ($$v) {_vm.$set(_vm.doc, "status", $$v)},expression:"doc.status"}}),_vm._ssrNode(" <div class=\"center-space\">"+((_vm.loading)?("<img src=\"/loading.gif\" class=\"loading\">"):"<!---->")+" "+((_vm.updated)?("<img src=\"/complete.gif\" class=\"action-complete\">"):"<!---->")+" <button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? "Edit" : "Add")+" Base Color ")+"</button> "+((_vm.editMode)?("<button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action delete\"> Delete </button>"):"<!---->")+"</div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/admin/colors/UpdateBaseColor.vue?vue&type=template&id=7fc5b97f&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/colors/UpdateBaseColor.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var UpdateBaseColorvue_type_script_lang_js_ = ({
  props: {
    model: String
  },
...
// CONCATENATED MODULE: ./components/admin/colors/UpdateBaseColor.vue?vue&type=script&lang=js&
 /* harmony default export */ var colors_UpdateBaseColorvue_type_script_lang_js_ = (UpdateBaseColorvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/admin/colors/UpdateBaseColor.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  colors_UpdateBaseColorvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var UpdateBaseColor = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/baseColors.vue?vue&type=template&id=302f1f18&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"color-categories crud"},[_vm._ssrNode("<div"+(_vm._ssrClass("filters center",{updating: _vm.showForm}))+"><input type=\"text\" placeholder=\"Search for Base Colors\""+(_vm._ssrAttr("value",(_vm.rawCriterion.search.term)))+" class=\"search shadow\"></div> "),_vm._ssrNode("<div"+(_vm._ssrClass("list",{updating: _vm.showForm}))+">","</div>",[_c('List',{attrs:{"list":_vm.list,"model":_vm.model,"headings":_vm.headings,"custom_css":"10% 40% 25% 10% 15%","sortByFields":_vm.sortByFields,"isDraggable":true},on:{"documentFetched":_vm.documentFetched,"sortToggled":_vm.sortToggled,"clearFilters":_vm.clearFilters,"refetchList":function($event){return _vm.updateList()}}}),_vm._ssrNode(" "),_c('Pagination',{ref:"pagination",attrs:{"model":_vm.model,"rawCriterion":_vm.rawCriterion},on:{"resultsFetched":_vm.resultsFetched}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div"+(_vm._ssrClass("update",{updating: _vm.showForm}))+">","</div>",[_c('UpdateBaseColor',{directives:[{name:"show",rawName:"v-show",value:(_vm.showForm),expression:"showForm"}],ref:"updateComponent",attrs:{"model":_vm.model},on:{"updated":_vm.updateList,"close":function($event){_vm.showForm = false}}}),_vm._ssrNode(" "),(!_vm.showForm)?_c('AddNewItem',{attrs:{"label":"Base Color"},on:{"showForm":function($event){_vm.showForm = true}}}):_vm._e()],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin-panel/baseColors.vue?vue&type=template&id=302f1f18&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/baseColors.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var baseColorsvue_type_script_lang_js_ = ({
  layout: 'admin',
...
// CONCATENATED MODULE: ./pages/admin-panel/baseColors.vue?vue&type=script&lang=js&
 /* harmony default export */ var admin_panel_baseColorsvue_type_script_lang_js_ = (baseColorsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admin-panel/baseColors.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_panel_baseColorsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var baseColors = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {List: __webpack_require__(152).default,Pagination: __webpack_require__(153).default,UpdateBaseColor: __webpack_require__(450).default,AddNewItem: __webpack_require__(157).default})
