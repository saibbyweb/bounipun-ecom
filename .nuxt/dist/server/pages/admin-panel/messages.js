exports.ids = [136,9,34,41,47,58,59,60,77];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/messages/UpdateMessage.vue?vue&type=template&id=2fb07def&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"contents"},[_c('CancelUpdate',{on:{"close":_vm.closeForm}}),_vm._ssrNode(" <h2 class=\"heading\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? 'Update' : 'Add New')+" Message ")+"</h2> "),(_vm.editMode)?_c('InputBox',{attrs:{"label":"Message ID","disabled":"","internal":true},model:{value:(_vm.doc._id),callback:function ($$v) {_vm.$set(_vm.doc, "_id", $$v)},expression:"doc._id"}}):_vm._e(),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Variant Name","disabled":""},model:{value:(_vm.doc.name),callback:function ($$v) {_vm.$set(_vm.doc, "name", $$v)},expression:"doc.name"}}),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Email","disabled":"","internal":true},model:{value:(_vm.doc.email),callback:function ($$v) {_vm.$set(_vm.doc, "email", $$v)},expression:"doc.email"}}),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Subject","disabled":""},model:{value:(_vm.doc.subject),callback:function ($$v) {_vm.$set(_vm.doc, "subject", $$v)},expression:"doc.subject"}}),_vm._ssrNode(" "),_c('TextBox',{attrs:{"label":"Subject","disabled":""},model:{value:(_vm.doc.message),callback:function ($$v) {_vm.$set(_vm.doc, "message", $$v)},expression:"doc.message"}}),_vm._ssrNode(" "),_c('Toggle',{attrs:{"label":"Status:","activeText":"Read","inactiveText":"Unread"},model:{value:(_vm.doc.read),callback:function ($$v) {_vm.$set(_vm.doc, "read", $$v)},expression:"doc.read"}}),_vm._ssrNode(" <div class=\"center-space\">"+((_vm.loading)?("<img src=\"/loading.gif\" class=\"loading\">"):"<!---->")+" "+((_vm.updated)?("<img src=\"/complete.gif\" class=\"action-complete\">"):"<!---->")+" <button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? "Edit" : "Add")+" Message ")+"</button> "+((_vm.editMode)?("<button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action delete\"> Delete </button>"):"<!---->")+"</div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/admin/messages/UpdateMessage.vue?vue&type=template&id=2fb07def&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/messages/UpdateMessage.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var UpdateMessagevue_type_script_lang_js_ = ({
  props: {
    model: String
  },
...
// CONCATENATED MODULE: ./components/admin/messages/UpdateMessage.vue?vue&type=script&lang=js&
 /* harmony default export */ var messages_UpdateMessagevue_type_script_lang_js_ = (UpdateMessagevue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/admin/messages/UpdateMessage.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  messages_UpdateMessagevue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var UpdateMessage = __webpack_exports__["default"] = (component.exports);
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/messages.vue?vue&type=template&id=bb67b148&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"messages crud"},[_vm._ssrNode("<div"+(_vm._ssrClass("filters center",{ updating: _vm.showForm }))+"><input type=\"text\" placeholder=\"Search for Message\""+(_vm._ssrAttr("value",(_vm.rawCriterion.search.term)))+" class=\"search shadow\"></div> "),_vm._ssrNode("<div"+(_vm._ssrClass("list",{ updating: _vm.showForm }))+">","</div>",[_c('List',{attrs:{"list":_vm.list,"model":_vm.model,"headings":_vm.headings,"custom_css":"10% 15% 30% 20% 15% 10%","sortByFields":_vm.sortByFields,"isDraggable":false},on:{"documentFetched":_vm.documentFetched,"sortToggled":_vm.sortToggled,"clearFilters":_vm.clearFilters,"refetchList":function($event){return _vm.updateList()}}}),_vm._ssrNode(" "),_c('Pagination',{ref:"pagination",attrs:{"model":_vm.model,"rawCriterion":_vm.rawCriterion},on:{"resultsFetched":_vm.resultsFetched}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div"+(_vm._ssrClass("update",{ updating: _vm.showForm }))+">","</div>",[_c('UpdateMessage',{directives:[{name:"show",rawName:"v-show",value:(_vm.showForm),expression:"showForm"}],ref:"updateComponent",attrs:{"model":_vm.model},on:{"updated":_vm.updateList,"close":function($event){_vm.showForm = false}}})],1)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin-panel/messages.vue?vue&type=template&id=bb67b148&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/messages.vue?vue&type=script&lang=js&
//
//
//
//
...
// CONCATENATED MODULE: ./pages/admin-panel/messages.vue?vue&type=script&lang=js&
 /* harmony default export */ var admin_panel_messagesvue_type_script_lang_js_ = (messagesvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admin-panel/messages.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_panel_messagesvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
