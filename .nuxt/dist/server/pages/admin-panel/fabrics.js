exports.ids = [127,3,9,34,41,47,55,58,59,60,73];
exports.modules = {
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/fabrics/UpdateFabric.vue?vue&type=template&id=67aefdd9&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"contents"},[_c('CancelUpdate',{on:{"close":_vm.closeForm}}),_vm._ssrNode(" <h2 class=\"heading\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? 'Update' : 'Add New')+" Fabric ")+"</h2> "),(_vm.editMode)?_c('InputBox',{attrs:{"label":"fabric ID","disbaled":"","internal":true},model:{value:(_vm.doc._id),callback:function ($$v) {_vm.$set(_vm.doc, "_id", $$v)},expression:"doc._id"}}):_vm._e(),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Code","internal":true},model:{value:(_vm.doc.code),callback:function ($$v) {_vm.$set(_vm.doc, "code", $$v)},expression:"doc.code"}}),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"fabric Name"},model:{value:(_vm.doc.name),callback:function ($$v) {_vm.$set(_vm.doc, "name", $$v)},expression:"doc.name"}}),_vm._ssrNode(" "),_c('InputBox',{attrs:{"label":"Info #1"},model:{value:(_vm.doc.info1),callback:function ($$v) {_vm.$set(_vm.doc, "info1", $$v)},expression:"doc.info1"}}),_vm._ssrNode(" "),_c('TextBox',{attrs:{"label":"Description"},model:{value:(_vm.doc.description),callback:function ($$v) {_vm.$set(_vm.doc, "description", $$v)},expression:"doc.description"}}),_vm._ssrNode(" "),_c('TextBox',{attrs:{"label":"Details And Care"},model:{value:(_vm.doc.detailsAndCare),callback:function ($$v) {_vm.$set(_vm.doc, "detailsAndCare", $$v)},expression:"doc.detailsAndCare"}}),_vm._ssrNode(" "),_c('TextBox',{attrs:{"label":"Write Up"},model:{value:(_vm.doc.writeUp),callback:function ($$v) {_vm.$set(_vm.doc, "writeUp", $$v)},expression:"doc.writeUp"}}),_vm._ssrNode(" "),_c('Toggle',{attrs:{"label":"Status"},model:{value:(_vm.doc.status),callback:function ($$v) {_vm.$set(_vm.doc, "status", $$v)},expression:"doc.status"}}),_vm._ssrNode(" <div class=\"center-space\">"+((_vm.loading)?("<img src=\"/loading.gif\" class=\"loading\">"):"<!---->")+" "+((_vm.updated)?("<img src=\"/complete.gif\" class=\"action-complete\">"):"<!---->")+" <button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action\">"+_vm._ssrEscape(" "+_vm._s(_vm.editMode ? "Edit" : "Add")+" Fabric ")+"</button> "+((_vm.editMode)?("<button"+(_vm._ssrAttr("disabled",_vm.loading))+" class=\"action delete\"> Delete </button>"):"<!---->")+"</div>")],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./components/admin/fabrics/UpdateFabric.vue?vue&type=template&id=67aefdd9&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./components/admin/fabrics/UpdateFabric.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var UpdateFabricvue_type_script_lang_js_ = ({
  props: {
    model: String
  },
...
// CONCATENATED MODULE: ./components/admin/fabrics/UpdateFabric.vue?vue&type=script&lang=js&
 /* harmony default export */ var fabrics_UpdateFabricvue_type_script_lang_js_ = (UpdateFabricvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./components/admin/fabrics/UpdateFabric.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  fabrics_UpdateFabricvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var UpdateFabric = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {CancelUpdate: __webpack_require__(134).default,InputBox: __webpack_require__(121).default,TextBox: __webpack_require__(124).default,Toggle: __webpack_require__(129).default})
...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/fabrics.vue?vue&type=template&id=10f1862c&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('div',{staticClass:"fabrics crud"},[_vm._ssrNode("<div"+(_vm._ssrClass("filters center",{updating: _vm.showForm}))+">","</div>",[_c('SelectBox',{attrs:{"options":_vm.searchBy,"label":"Search By"},model:{value:(_vm.rawCriterion.search.key),callback:function ($$v) {_vm.$set(_vm.rawCriterion.search, "key", $$v)},expression:"rawCriterion.search.key"}}),_vm._ssrNode(" <input type=\"text\" placeholder=\"Search for Fabrics\""+(_vm._ssrAttr("value",(_vm.rawCriterion.search.term)))+" class=\"search shadow\">")],2),_vm._ssrNode(" "),_vm._ssrNode("<div"+(_vm._ssrClass("list",{updating: _vm.showForm}))+">","</div>",[_c('List',{attrs:{"list":_vm.list,"model":_vm.model,"headings":_vm.headings,"custom_css":"10% 30% 20% 10% 15% 15%","sortByFields":_vm.sortByFields,"isDraggable":true},on:{"documentFetched":_vm.documentFetched,"sortToggled":_vm.sortToggled,"clearFilters":_vm.clearFilters,"refetchList":function($event){return _vm.updateList()}}}),_vm._ssrNode(" "),_c('Pagination',{ref:"pagination",attrs:{"model":_vm.model,"rawCriterion":_vm.rawCriterion},on:{"resultsFetched":_vm.resultsFetched}})],2),_vm._ssrNode(" "),_vm._ssrNode("<div"+(_vm._ssrClass("update",{updating: _vm.showForm}))+">","</div>",[_c('UpdateFabric',{directives:[{name:"show",rawName:"v-show",value:(_vm.showForm),expression:"showForm"}],ref:"updateComponent",attrs:{"model":_vm.model},on:{"updated":_vm.updateList,"close":function($event){_vm.showForm = false}}}),_vm._ssrNode(" "),(!_vm.showForm)?_c('AddNewItem',{attrs:{"label":"fabric"},on:{"showForm":function($event){_vm.showForm = true}}}):_vm._e()],2)],2)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/admin-panel/fabrics.vue?vue&type=template&id=10f1862c&

// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./pages/admin-panel/fabrics.vue?vue&type=script&lang=js&
//
//
//
//
...
//
//
/* harmony default export */ var fabricsvue_type_script_lang_js_ = ({
  layout: 'admin',
...
// CONCATENATED MODULE: ./pages/admin-panel/fabrics.vue?vue&type=script&lang=js&
 /* harmony default export */ var admin_panel_fabricsvue_type_script_lang_js_ = (fabricsvue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(1);

// CONCATENATED MODULE: ./pages/admin-panel/fabrics.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  admin_panel_fabricsvue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var fabrics = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {SelectBox: __webpack_require__(140).default,List: __webpack_require__(152).default,Pagination: __webpack_require__(153).default,UpdateFabric: __webpack_require__(457).default,AddNewItem: __webpack_require__(157).default})
