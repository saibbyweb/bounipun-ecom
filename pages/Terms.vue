<template>
  <div class="page">
    <div class="wrapper">
      ...
      <!-- Covid19 Info -->
      <Accordion heading="Covid19 Information">
        <p>
        ...
        your patience and understanding! </p>
      </Accordion>
      ...
      <Accordion heading="Product Prices">
        ...
        sold for Indian prices outside the country.</p>
      </Accordion>
 ...
 <p>
        ...
        & $39 for domestic & international respectively.<br /><br />
        ...
        re-delivery shall be claimed by the user placing the order.<br /><br />

        <span class="bold">Standard Shipping:</span> Time taken to make, finish and pack the order.
        Standard shipping above one week are considered as custom-made orders,
        excluding ‘ready to ship’ orders.<br /><br />
        ...
        Orders" while you are logged in.<br /><br />
        ...
        of orders would be done address specific not person specific.<br /><br />
        ...
        Octroi charges levied shall not be refunded.<br /><br />
      ...
      <p>
        ...
        No refund or exchange will be entertained for custom-made orders. </p>
      </Accordion>
      ...
      <Accordion heading="Intellectual Property">
        ...
        any of the intellectual property on or associated with this website. </p>
      </Accordion>
