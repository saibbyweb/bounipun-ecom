...
<div class="color-categories crud">
    ...
    <div :class="{updating: showForm}" class="filters center">
        <input v-model="rawCriterion.search.term" class="search shadow" type="text" placeholder="Search for Color Categories" />
    </div>
    <!-- list of fabrics -->
    ...
    <div :class="{updating: showForm}" class="update">
        ...
        <UpdateColorCategory v-show="showForm" ref="updateComponent" @updated="updateList" :model="model" @close="showForm = false" />
