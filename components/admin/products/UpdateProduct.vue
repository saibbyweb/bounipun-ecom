...
<div class="contents">
    ...
    <!-- fabric selector -->
    <fabric-selector ref="fabricSelector" :label="variant.name" v-for="(variant, index) in selectedVariantsWithFabricOptions" :key="index" :variant="variant" @fabricSelectionUpdated="fabricSelectionUpdated" />
